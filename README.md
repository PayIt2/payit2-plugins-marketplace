...
|--------|------|-------------|
| **PayIt2 Campaign Coach** | [PayIt2/payit2-campaign-coach](https://github.com/PayIt2/payit2-campaign-coach) | AI-powered coach for fundraisers, events, and group collections. 5 skills, 4 commands, 3 agents. |
